...
const Feed = () => {
    ...
    const [sort, setSort] = useState({
        url: 'https://motifs-server.herokuapp.com/feed' 
    ...
    function switchToBookmarkFeed(){
        setSort({
            url :`https://motifs-server.herokuapp.com/library`,
        })
        setSortClass({
            all: "sortSecBtn",
    ...
    function switchToFollowingFeed(){
        setSort({
            url :`https://motifs-server.herokuapp.com/followingFeed`,
        })
        setSortClass({
            all: "sortSecBtn",
            bookmark: "sortSecBtn margin-left2",
    ...
    const logout = async () => {
        ...
        await fetch('https://motifs-server.herokuapp.com/auth/logoutUser', {
            method: 'POST',
