...
const TrackButtons = (props) => {
    ...
    useEffect(() => {
        ( async () => {
            axios.get(`https://motifs-server.herokuapp.com/getSinglePost/${props.id}`, {headers: {Authentication: loggedInUserContext?.accesstoken}})
            .then(({ data }) => {
    ...
    function toggleBookmark(){
        ...
        (async () => {
            await axios.post(`https://motifs-server.herokuapp.com/post/likePost/${props.id}?_method=PUT`,{},{headers: {Authentication: loggedInUserContext?.accesstoken}})
        })()
        toggle(!bookState)
    }
    function toggleFollowButton(){
        ...
        (async () => {
            await axios.post(`https://motifs-server.herokuapp.com/post/followArtist/${props.userWhoCreatedPost}?_method=PUT`,{}, {headers: {Authentication: loggedInUserContext?.accesstoken}})
        })()
    ...
    function deleteTrack(){
        ...
        (async () => {
            await axios.post(`https://motifs-server.herokuapp.com/post/deletePost/${props.id}?_method=DELETE`,{}, {headers: {Authentication: loggedInUserContext?.accesstoken}})
        })()
